...
// const TypeChecker _injectableChecker = TypeChecker.fromRuntime(Repository);
...
class DependencyResolver {
  ...
  final TypeChecker injectableChecker;
  ...
  DependencyResolver(this.injectableChecker, this._typeResolver);
  ...
  DependencyConfig _resolveActualType(
    ...
    _typeImpl = _type;
    var injectableAnnotation = injectableChecker.firstAnnotationOf(
      annotatedElement,
    ...
    if (injectableAnnotation != null) {
      ...
      if (injectable.instanceOf(const TypeChecker.fromRuntime(LazySingleton))) {
